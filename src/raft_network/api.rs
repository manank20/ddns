 ...
 */
#[post("/write")]
pub async fn write(app: Data<RaftDNS>, req: Json<Request>) -> actix_web::Result<impl Responder> {
    let response = app.raft.client_write(req.0).await;
    Ok(Json(response))
}

#[post("/read")]
pub async fn read(app: Data<RaftDNS>, req: Json<String>) -> actix_web::Result<impl Responder> {
...
pub async fn consistent_read(app: Data<RaftDNS>, req: Json<String>) -> actix_web::Result<impl Responder> {
